...
import { getFuncIllusionary128836018189 } from "./Yuu API/funcIllusionary128836018189Model";
import { getGlowyellowTexture } from "./Yuu API/glowyellowTexture";
import { getFuncIllusionary128836018208 } from "./Yuu API/funcIllusionary128836018208Model";
import { getWorldspawn18943 } from "./Yuu API/worldspawn18943Model";
import { getMossTexture } from "./Yuu API/mossTexture";
...
import { getBlend02Texture } from "./Yuu API/blend02Texture";
...
function spawnModel(
  ...
  entity.scale = scale;
  if (getTexture) {
    const tex = typeof getTexture === 'function' ? getTexture() : getTexture;
    entity.mesh.texture.set(tex, false);
  }
  return entity;
}
...
async function spawnChamber() {
  const chamber = spawnPrimitive.cube(new Vector3(0, 2, 0), new Vector3(2, 2, 2), Quaternion.one, new Color(0.1, 0.5, 0.1), 1, true, 'Static', undefined);
...
export async function spawnScene() {
  // Spawn func_illusionary_1288360_18189 (Texture: glowyellow.png)
  spawnModel(
    getFuncIllusionary128836018189,
    new Vector3(-0.094280, 1.877411, 0.138733),
    new Vector3(0.010000, 0.010000, 0.010000),
    new Quaternion(0.000000, 0.000000, 0.000000, 1.000000),
    getGlowyellowTexture
  );

  // Spawn func_illusionary_1288360_18208 (Texture: glowyellow.png)
  spawnModel(
    getFuncIllusionary128836018208,
    new Vector3(-0.094280, 0.289902, 0.138733),
    new Vector3(0.010000, 0.010000, 0.010000),
    new Quaternion(0.000000, 0.000000, 0.000000, 1.000000),
    getGlowyellowTexture
  );

  // Spawn worldspawn_1_8943 (Texture: moss.png)
  spawnModel(
    getWorldspawn18943,
  ...
  // Spawn worldspawn_1_8950 (Texture: moss.png)
  spawnModel(
    getWorldspawn18950,
  ...
  // Spawn worldspawn_1_8957 (Texture: moss.png)
  spawnModel(
    getWorldspawn18957,
  ...
  // Spawn worldspawn_1_8964 (Texture: moss.png)
  spawnModel(
    getWorldspawn18964,
  ...
  // Spawn worldspawn_1_8971 (Texture: moss.png)
  spawnModel(
    getWorldspawn18971,
  ...
  // Spawn worldspawn_1_10399 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110399,
  ...
  // Spawn worldspawn_1_10406 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110406,
  ...
  // Spawn worldspawn_1_10413 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110413,
  ...
  // Spawn worldspawn_1_10420 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110420,
  ...
  // Spawn worldspawn_1_10427 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110427,
  ...
  // Spawn worldspawn_1_10434 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110434,
  ...
  // Spawn worldspawn_1_10441 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110441,
  ...
  // Spawn worldspawn_1_10448 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110448,
  ...
  // Spawn worldspawn_1_10455 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110455,
  ...
  // Spawn worldspawn_1_10462 (Texture: blend02.png)
  spawnModel(
    getWorldspawn110462,
  ...
  // Spawn worldspawn_1_10469 (Texture: glowyellow.png)
  spawnModel(
    getWorldspawn110469,
  ...
  // Spawn worldspawn_1_10476 (Texture: glowyellow.png)
  spawnModel(
    getWorldspawn110476,
  ...
  // Spawn worldspawn_1_10483 (Texture: glowyellow.png)
  spawnModel(
    getWorldspawn110483,
  ...
  // Spawn worldspawn_1_10490 (Texture: glowyellow.png)
  spawnModel(
    getWorldspawn110490,
  ...
  // Spawn worldspawn_1_10497 (Texture: glowyellow.png)
  spawnModel(
    getWorldspawn110497,
  ...
  // Spawn prop_static_55602 (Texture: black.png)
  spawnModel(
    getPropStatic55602,
  ...
  // Spawn prop_static_55785 (Texture: oakwoodveneer.png)
  spawnModel(
    getPropStatic55785,
    new Vector3(1.627830, 0.875397, -1.583282),
    new Vector3(0.010000, 0.010000, 0.010000),
    new Quaternion(0.120590, 0.379410, 0.049950, -0.915976),
    getOakwoodveneerTexture
  );

  // Spawn prop_static_55786 (Texture: white.png)
  spawnModel(
    getPropStatic55786,
  ...
  // Spawn prop_static_55862 (Texture: hedge.png)
  spawnModel(
    getPropStatic55862,
  ...
  // Spawn prop_static_55863 (Texture: footpath.png)
  spawnModel(
    getPropStatic55863,
  ...
  // Spawn prop_static_55864 (Texture: oakwoodveneer.png)
  spawnModel(
    getPropStatic55864,
  ...
  // Spawn prop_static_55865 (Texture: boatwood.png)
  spawnModel(
    getPropStatic55865,
